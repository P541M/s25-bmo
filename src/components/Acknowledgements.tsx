...
const Acknowledgements = () => {
  ...
  const mentors = [
    ...
    },
    {
      ...
      contribution: "Served as an incredibly understanding and supportive mentor throughout the IdeaVerse platform transformation. She created an environment where I could grow and learn from mistakes while consistently challenging me to reach new heights. Her balanced approach of encouragement and accountability was instrumental in my professional growth.",
      image: "👨‍💼",
    ...
    },
    {
      ...
      contribution: "Opened the door to exploring cutting-edge technologies, allowing me to dive deep into agentic AI research and other emerging tech areas. His encouragement to push boundaries and explore new technological frontiers was transformational, giving me the freedom to grow while providing the guidance needed to produce meaningful research outcomes.",
      image: "👨‍🔬",
  ...
  const teammates = [
    {
      ...
      contribution: "Marc's collaborative partner who played a crucial role in my early onboarding experience. His mentorship during my first days at BMO helped me navigate the research environment with confidence and provided the foundation I needed to succeed in both IdeaVerse development and emerging technology research."
    },
    {
      name: "Taha Yar Khan",
      role: "Fellow Intern & Peer",
      contribution: "My fellow intern who became not just a colleague but a true friend throughout our BMO journey. We bonded over shared experiences, supported each other through challenges, and created lasting memories. Having someone to share the intern experience with made the entire work term more meaningful and enjoyable."
    }
  ];
    ...
    <section id="acknowledgements" className="section-padding bg-gradient-to-br from-purple-50 to-pink-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-20 transition-all duration-1000 delay-500 ${
          ...
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-12">Colleagues & Friends</h3>
        ...
        <div className={`mb-20 transition-all duration-1000 delay-600 ${
          ...
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-12">Special Recognition</h3>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg card-hover">
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-center">
                <div className="text-center lg:text-left">
                  ...
                  <h4 className="text-xl font-bold text-gray-900 mb-1">Emma Connell</h4>
                  <p className="text-bmo-blue font-semibold text-sm mb-1">BMO Recruiter</p>
                  <p className="text-gray-500 text-sm">Talent Acquisition</p>
                </div>
                <div className="lg:col-span-3">
                  <p className="text-gray-600 leading-relaxed text-lg">
                    The person who made it all possible! Emma reached out to me with this incredible opportunity and made the entire process of joining BMO absolutely delightful. Her professionalism, warmth, and attention to detail set the perfect tone for what would become a transformational work experience. Thank you for believing in me and opening the door to this amazing journey.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  professional growth. The opportunity to contribute to both IdeaVerse platform transformation and 
                  cutting-edge AI research at one of Canada&apos;s leading financial institutions has been invaluable.
                </p>
              </div>
              <div className="text-center">
        ...
        <div className={`transition-all duration-1000 delay-1000 ${
          ...
          <div className="bg-gradient-to-br from-bmo-red to-bmo-blue rounded-3xl p-8 text-white text-center">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-6">
              To Sharon, Omosefe, Marc, Tomas, Taha, and Emma—each of you contributed uniquely to my growth and success 
              during this transformational work term at BMO. From career guidance and project mentorship to research 
              opportunities and lasting friendships, your support has shaped not just my professional development but 
              also my personal journey. The relationships we've built and the lessons I've learned will continue to 
              guide my path in technology and innovation for years to come.
            </p>
