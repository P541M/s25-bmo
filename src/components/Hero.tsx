  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-white">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h1 className="mb-8">
            <span className="block text-2xl md:text-3xl text-gray-700 font-medium mb-3 tracking-wide">
              Technology Innovation at
            </span>
            <span className="block text-4xl md:text-5xl text-bmo-blue font-semibold tracking-tight">
              BMO Financial Group
            </span>
          </h1>
        </div>
        ...
        >
          <button
            ...
            className="bg-bmo-blue hover:bg-blue-700 text-white text-base px-8 py-3 rounded-lg font-medium transition-colors duration-300"
          >
            Explore My Journey
          </button>
        </div>
